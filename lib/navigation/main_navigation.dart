...
import '../screens/karaoke/karaoke_screen.dart';
...
class _BottomBar extends StatelessWidget {
  ...
  static const _items = [
    ...
    _NavDef('Karaoke', Icons.mic_none_rounded,           Icons.mic_rounded),
    ...
    return GestureDetector(
      ...
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        AnimatedContainer(
          ...
          width: widget.active ? 26 : 0, height: 2.5,
        ...
        ScaleTransition(
          ...
          child: AnimatedContainer(
            ...
            child: Icon(
              widget.active ? widget.def.activeIcon : widget.def.icon,
              color: color, size: 20,
            ),
          ),
        ),
