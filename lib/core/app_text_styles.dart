...
class AppTextStyles {
  ...
  static TextStyle get heading1 => GoogleFonts.nunito(
      ...
      color: AppColors.white, letterSpacing: -0.5, height: 1.2);

  static TextStyle get heading2 => GoogleFonts.nunito(
      fontSize: 20, fontWeight: FontWeight.w800,
      color: AppColors.white, letterSpacing: -0.3, height: 1.3);
  ...
  static TextStyle get goldHeading => GoogleFonts.nunito(
      fontSize: 19, fontWeight: FontWeight.w800, color: AppColors.gold);
  ...
  static TextStyle get verseText => GoogleFonts.nunito(
      fontSize: 16, fontWeight: FontWeight.w600,
      color: AppColors.white, height: 1.7, fontStyle: FontStyle.italic);

  static TextStyle get verseRef => GoogleFonts.nunito(
